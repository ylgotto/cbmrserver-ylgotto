...
namespace Roles
{
	...
	void Initialize()
	{
		...
		Role@ Spectator = Role(ROLE_SPECTATOR, "观众", CATEGORY_STALEMATE, PlayerModel(0), Color(200, 200, 200), "");
		
		Role@ ClassD = Role(ROLE_CLASS_D, "D级人员", CATEGORY_INMATE, PlayerModel(CLASS_D_MODEL), Color(212,113,0), "逃离设施. 寻找救援. 不要相信任何人.",
		{
		...
		Role@ Scientist = Role(ROLE_SCIENTIST, "研究员", CATEGORY_STAFF, 
		...
		Role@ GOC = Role(ROLE_GOC, "最优质的战士", CATEGORY_GOC, PlayerModel(GOC_MODEL, {GOC_TEXTURE}), Color(89, 148, 229), "上市每一个人.",
		{ 
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			Spawnpoint(vector3(frand(-4000.0, -4500.0), -1185, frand(6300.0, 5300.0)), 0.0, -90.0, gate_a),
			...
			Spawnpoint(vector3(frand(-4437.0, -4000.0), 1320, frand(6200.0, 6800.0)), 0.0, -90.0, gate_a_b),
			Spawnpoint(vector3(frand(-4437.0, -4000.0), 1320, frand(6200.0, 6800.0)), 0.0, -90.0, gate_a_b)
		}, {"M4A1", "M60", "Key Card Omni", "Radio Transceiver", "Handcuffs;Compact First Aid Kit;Compact First Aid Kit;Ballistic Helmet;Heavy Ballistic Vest;Ammo crate"});
		...
		Role@ scp096 = Role(ROLE_SCP_096, "SCP-096（屏蔽仪高手）", CATEGORY_ANOMALY, PlayerModel(SCP_096_MODEL), Color(200, 0, 0), "上市每一个人. 等待45秒移动.",
		{
		...
		Role@ scp999 = Role(ROLE_SCP_999, "SCP-999（狗三狗）", CATEGORY_ANOMALYSTALEMATE, PlayerModel(SCP_999_MODEL), Color(200, 50, 50), "干死你想要干的人.",
		{
